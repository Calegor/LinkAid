            ...
            <div className="relative w-full max-w-[480px]">
              <div className="absolute -top-50 left-1/2 -translate-x-1/2 w-[240px] md:-top-25 md:left-[65px] md:right-auto md:translate-x-0 z-30 animate-bounce duration-[2000ms]">
                <div className="bg-white border-[1.5px] border-slate-900/30 p-5 rounded-[2.5rem] shadow-[0_10px_30px_rgba(0,0,0,0.06)] relative">
                  ...
                  <div className="absolute bg-white w-3 h-3 border-slate-900/30 -bottom-1.5 left-1/2 -translate-x-1/2 rotate-45 border-r-[1.5px] border-b-[1.5px] md:top-auto md:bottom-8 md:-left-1.5 md:right-auto md:translate-x-0 md:rotate-[135deg] md:border-r-[1.5px] md:border-b-[1.5px]"></div>
                </div>
              </div>
              ...
              >
                {!isSuccess ? (
                  ...
                  <div className="py-20 flex flex-col items-center text-center animate-in fade-in zoom-in duration-500">
                    ...
                    <p className="text-slate-500 font-light text-sm max-w-[280px]">
                      Obrigado,{" "}

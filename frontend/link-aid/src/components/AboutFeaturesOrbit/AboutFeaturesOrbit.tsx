...
const AboutFeaturesOrbit = () => {
  ...
  return (
    <section className="w-full pt-12 pb-24 lg:pt-48 lg:pb-32 bg-white relative">
                  ...
                  {featuresData.map((feature, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <div
                            className={`w-10 h-10 md:w-16 md:h-16 rounded-2xl flex items-center justify-center transition-all duration-500 animate-soft-pulse
                            ${
                              isActive
              ...
              {activeFeature ? (
                <div className="w-full animate-in fade-in slide-in-from-right-6 duration-500 overflow-visible">
                  <div className="bg-white rounded-[2.5rem] p-8 md:p-10 border border-slate-100 shadow-[0_40px_80px_rgba(0,0,0,0.12)] relative overflow-hidden group text-left">
                    <button
                      onClick={closeCard}
                      className="absolute top-6 right-6 text-slate-300 hover:text-slate-900 transition-colors focus:outline-none"
                    >
                    ...
                    <div className="flex items-center gap-5 mb-6">
                      ...
                      <div className="flex flex-col">
                        <h3 className="text-slate-900 text-2xl font-bold tracking-tight leading-none">
                          {activeFeature.name}
                        </h3>
                        <span className="text-[10px] font-bold text-blue-500 uppercase tracking-[0.2em] mt-2">
                          {activeFeature.tech}
                        </span>
                      </div>
                    </div>
                ...
                <div className="flex flex-col items-center lg:items-end gap-4 py-4 opacity-40">
                  <div className="flex items-center gap-3">
                    <span className="text-slate-400 text-[10px] uppercase tracking-[0.4em] font-bold">
                      Aguardando seleção
                    </span>
